...
import { useCart, useLocalStorage } from "../../refactoring/hooks";
...
describe("advanced > ", () => {
  ...
  describe("useLocalStorage", () => {
    ...
    //   expect(window.localStorage.getItem('key')).toBe(JSON.stringify({ a: 2 }));
    // });

    // it('should handle initialization with existing localStorage value', () => {
