...
import MonthCalendar from "./components/MonthCalendarView";
import useGetFilteredEvents from "./hooks/useGetFilteredEvents";
import WeekCalendar from "./components/WeekCalendarView";
import { notificationOptions } from "./shared/notification";
...
function App() {
  ...
  // 겹치는 일정을 찾는 함수
  const findOverlappingEvents = (newEvent: EventType): EventType[] => {
    ...
    <Box w="full" h="100vh" m="auto" p={5}>
      <Flex gap={6} h="full">
        ...
        <VStack flex={1} spacing={5} align="stretch">
          ...
          {view === "week" && (
            <WeekCalendar currentDate={currentDate} searchTerm={searchTerm} />
          )}
          {view === "month" && (
            <MonthCalendar
