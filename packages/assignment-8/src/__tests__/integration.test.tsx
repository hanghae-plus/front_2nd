...
describe("일정 관리 애플리케이션 통합 테스트", () => {
  ...
  describe("반복 일정", () => {
    describe("반복 유형 선택", () => {
      test("일정 생성 시, 반복 유형 매일, 매주, 매월, 매년을 선택할 수 있다.", () => {});
      test("일정 수정 시, 반복 유형 매일, 매주, 매월, 매년을 선택할 수 있다.", () => {});
      test("일정 생성 시, 반복 유형 간격을 선택할 수 있다", () => {});
      test("일정 수정 시, 반복 유형 간격을 선택할 수 있다", () => {});
    });
    describe("반복 유형 세부 선택", () => {
      test("일정 생성 시, 반복 일정 중 특정 날짜를 제외 할 수 있다", () => {});
      test("일정 수정 시, 반복 일정 중 특정 날짜를 제외 할 수 있다", () => {});
      test("일정 생성 시, 반복 종료 조건으로 특정 날짜까지, 특정 횟수만큼, 종료 없음 지정할 수 있다", () => {});
      test("일정 수정 시, 반복 종료 조건으로 특정 날짜까지, 특정 횟수만큼, 종료 없음 지정할 수 있다", () => {});
      test("일정 생성 시, 특정 요일을 선택 할 수 있다", () => {});
      test("일정 수정 시, 특정 요일을 선택 할 수 있다", () => {});
      test("일정 생성 시, 매월 특정 날짜에 반복되도록 선택 할 수 있다", () => {});
      test("일정 수정 시, 매월 특정 날짜에 반복되도록 선택 할 수 있다", () => {});
    });
    describe("반복 세부 수정", () => {
      test("일정 수정 시, 반복 일정의 단일 일정을 수정할 수 있다", () => {});
      test("일정 수정 시, 반복 일정의 모든 일정을 수정할 수 있다", () => {});
    });
    describe("반복 달력 내 확인", () => {
      test("일정 생성 시, 반복 일정을 달력에서 확인할 수 있다", () => {});
      test("일정 수정 시, 반복 일정을 달력에서 확인할 수 있다", () => {});
    });
  });
});
