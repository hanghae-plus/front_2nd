...
describe('advanced test', () => {
  ...
  describe('Templates > ', () => {
    ...
    <div>
      <button class="quantity-change bg-blue-500 text-white px-2 py-1 rounded mr-1" data-product-id="p1" data-change="-1" data-action="decrease">-</button>
      <button class="quantity-change bg-blue-500 text-white px-2 py-1 rounded mr-1" data-product-id="p1" data-change="1" data-action="increase">+</button>
      <button class="remove-item bg-red-500 text-white px-2 py-1 rounded" data-product-id="p1" data-action="remove">삭제</button>
    </div>
  </div>`);
      });
    });
