  ...
  describe('createShoppingCart >', () => {
    ...
    describe('할인 로직', () => {
        ...
        it.each([
          {
            ...
            discount: productList[0].discount[0][1] * 100,
            expected: 90000,
          }, // [0, 10, 90000],  // 상품1
          {
            product: productList[1],
            discount: productList[1].discount[0][1] * 100,
            expected: 170000,
          }, // [1, 10, 170000], // 상품2
          {
            product: productList[2],
            discount: productList[2].discount[0][1] * 100,
            expected: 240000,
          }, // [2, 10, 240000]  // 상품3
        ])(
      ...
      it('30개 이상 구매 시 전체 25% 할인이 적용되어야 한다', () => {
        cart.addItem(productList[0], 15);
        cart.addItem(productList[1], 15);
        expect(cart.getTotal().total).toBe(337500); // (10000 * 15 + 20000 * 15) * 0.75
      });

      it('개별 상품 할인과 전체 할인 중 더 큰 할인이 적용되어야 한다', () => {
        cart.addItem(productList[0], 15); // 10% 할인
        cart.addItem(productList[2], 15); // 20% 할인
